...
import {Card, Cards, Circle, Column, Container, Content, Mask, Text, Inner} from "./style"
        ...
        <>
            {data &&  <Content 
                ...
                <Container className='container d-flex flex-column gap-5 overflow-hidden block-objective'>
                    ...
                    <Cards className="d-flex flex-wrap flex-column flex-md-row justify-content-center align-items-stretch">
                        {data && data.map((item:any, index:any) => (
                            <Card key={index} className='col-12 col-md-6 col-lg-4'>
