        ...
        {config && lang && 
            <>
                ...
                <ErrorPage className="overflow-hidden d-flex flex-column justify-content-center align-items-center">
                    <div className="d-flex flex-column justify-content-center align-items-center" dangerouslySetInnerHTML={{__html: config?.error_page[lang?.key.replace("-","_") || 'pt_br']?.value}} />
                    <Mask 
